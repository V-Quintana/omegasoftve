            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12" style="padding-right: 90px;padding-left:90px;">
                   <div style="text-align: center">
                       <h2 style="margin-top: 50px">Comenarios</h2>
                   </div>
                   ...
                   <table class="table table-striped  table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="width: 40%">Comentario</th>                               
                    ...
                    <tbody>
                        @foreach($expenseReports as $item)
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="{{ route('commentary-delete', $item->id) }}" style="color:#fff;font-size:12px;font-weight:600;text-decoration:none">
