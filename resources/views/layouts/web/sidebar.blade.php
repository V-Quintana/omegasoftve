...
<div class="preloader"></div>
                      ...
                      <div class="top-right clearfix" style = "float: left !important;">
                          <ul class="info clearfix" style="margin-bottom: 0rem; padding-top: 7px;">
                              ...
                              <li style="color: #fff; font-size: 15px;"><span style="width: 17px;" class="fa fa-phone"></span>(58) 244 386 8448</li>
                                ...
                                <div class="" style = "float: left !important; padding-left: 243px; " >
                                                    ...
                                                    <div class="footer-upper2">
                                                        <div class="social-links2" style ="display: inline-block;">
                                                            <ul class="clearfix" >
                                                                ...
                                                                <li style = "margin-right: 3px;"><a style = "padding-left:0px;" target="_black" href="https://twitter.com/Omegasoft_ca"><span class="fa fa-twitter"></span></a></li>
              ...
              <div class="main-box">
                  <div class="auto-container">
                      <div class="clearfix">
                          ...
                          <div class="logo-box">
                              <div class="logo"><a href="{{ route('index') }}"><img src="{{ URL::to('/') }}/images/logo.png" alt="LOGO_EMPRESA" title=""></a></div>
                          </div>
                                      ...
                                      <ul class="navigation clearfix">
                                          ...
                                          <li class="dropdown"><a href="">Soporte</a>
                                                <ul>
                                                  ...
                                                  <li><a style="text-transform: none" target="_blank" href="https://162.252.57.243/login/?next=/OmegaUsers/tickets/">Ticket de Soporte</a></li>
                                          ...
                                          <li class="dropdown"><a href="">Comunidad</a>
                                              <ul>
                                                  <li><a style="text-transform: none " href="{{ URL::to('/') }}/blog/">Blog</a></li>
                                                  <li><a style="text-transform: none " href="{{ URL::to('/') }}/newsletter/">Newsletter</a></li>
                                              </ul>
                                          </li>
              ...
              <div class="sticky-header">
                  <div class="auto-container clearfix">
                      ...
                      <div class="logo pull-left">
                          <a href="{{ route('index') }}" class="img-responsive"><img src="{{ URL::to('/') }}/images/logo-small.png" alt="LOGO_EMPRESA" title=""></a>
                      </div>
      ...
      <!--End Main Header -->
      @include('web.modals.IndexCotizacion')
