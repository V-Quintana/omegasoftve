...
@section('title', 'Omegasoft - Quienes Somos')
@section('description', 'Proveedor de soluciones empresariales para la gestión de servicios IT.')
@section('content')
    <section class="page-title">
    	<div class="image-layer" style="opacity: 10.0;"></div>
         <img src="{{ URL::to('/') }}/images/background/quienes-somos.jpg" alt="EMPRESA_SOFTWARE ">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 40px;">
                    <div class="sec-title centered" style="margin-bottom: 15px;">
                        ...
                        empresas, soluciones y servicios para mejorar sus capacidades empresariales, 
                        enfocándonos en la simplificación de sus procesos, empleando metodologías adaptativas.            
                        </div>
                    </div>
                    <div class="sec-title centered">
                        <div class="text">
                        Nuestros principales objetivos son combinar la facilidad, la accesibilidad y la practicidad al
                        proporcionar soluciones flexibles y asequibles a las empresas, permitiéndoles obtener control
    ...
    <section class = "">
        <div class="sec-title-two centered" style = "margin-bottom: 0px;">
            ...
                                  <div class="timeline-icon2">
                                        <figure class="icon-box"><img src="{{ URL::to('/') }}/images/icons/lanzamiento-2.jpg" alt="SOFTWARE_ITSM"></figure>
                                  </div>
                                  <div class="content">
            ...
                                       <figure class="icon-box"><img src="{{ URL::to('/') }}/images/icons/lanzamiento-1.jpg" alt="SOFTWARE_IT"></figure>
                                  </div>
                                  <div class="content">
                                    <h3 class="title">2016</h3>
                                    <p class="description">Iniciamos el proceso de desarrollo de nuestro primer software para la gestión de servicios IT basadas en las buenas prácticas ITIL, integrando firmemente toda la funcionalidad necesaria para orquestar las interacciones de personas, procesos y tecnologías para un rendimiento óptimo siendo intuitivo y accesible para los usuarios no técnicos.
                                    </p>
                                  </div>
                                </a>
                            </div>
            ...
                                <a href="#" class="timeline-content">
                                  <div class="timeline-icon">
                                     <figure class="icon-box"><img src="{{ URL::to('/') }}/images/icons/2013.png" alt="ALIANZAS_ESTRATEGICAS"></figure>
                                  </div>
                                  <div class="content">
            ...
                                <a href="#" class="timeline-content">
                                  <div class="timeline-icon2">
                                       <figure class="icon-box"><img src="{{ URL::to('/') }}/images/icons/nacimiento.jpg" alt="EMPRESA_SERVICIO"></figure>
                                  </div>
                                  <div class="content">
                        ...
                        <div class="inner-box"  style = "height: 530px !important;"  >
                            ...
                            <div class="lower-box">
                                <div class="sec-title centered">
                                    ...
                                    apoyo a las empresas para satisfacer las necesidades de sus clientes.
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="logos">
                                <div class="row clearfix">
                                    <div class="logo-column col-md-6 col-sm-6 col-xs-12">
                                        <figure class="image"><a href="https://www.multinacional.com.ve/Multinacional/"><img src="{{ URL::to('/') }}/images/clients/1.png" alt="CLIENTES"></a></figure>
                                    </div>
                                    <div class="logo-column col-md-6 col-sm-6 col-xs-12">
                                        <figure class="image"><a href="https://www.seguroscaracas.com/portal/paginasv4/"><img src="{{ URL::to('/') }}/images/clients/2.png" alt="CLIENTES"></a></figure>
                                    </div>
                                    <div class="logo-column col-md-6 col-sm-6 col-xs-12">
                                        <figure class="image"><a href="http://www.fundacionsantateresa.org/web/inicio.php"><img src="{{ URL::to('/') }}/images/clients/3.png" alt="CLIENTES"></a></figure>
                                    </div>
                                    <div class="logo-column col-md-6 col-sm-6 col-xs-12">
                                        <figure class="image"><a href="https://www.grupophoenix.com/es/"><img src="{{ URL::to('/') }}/images/clients/4.png" alt="CLIENTES"></a></figure>
                                    </div>
                                    <div class="logo-column col-md-6 col-sm-6 col-xs-12">
                                        <figure class="image"><a href="https://www.mapfre.com.ve/"><img src="{{ URL::to('/') }}/images/clients/5.png" alt="CLIENTES"></a></figure>
                                    </div>
                                    <div class="logo-column col-md-6 col-sm-6 col-xs-12">
                                        <figure class="image"><a href="http://protinalproagro.com.ve/"><img src="{{ URL::to('/') }}/images/clients/6.png" alt="CLIENTES"></a></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="testimonial">
                                    <div class="testimonial-profile">
                                        <a href="https://www.linkedin.com/in/carlos-villegas-79540213b/">
                                            <img src="{{ URL::to('/') }}/images/resource/author-3.png" alt="EQUIPO_TECNOLOGIA">
                                        </a>
                                    </div>
                                    <div class="testimonial-content">
                                        ...
                                        Lo que más me gusta de trabajar en Omegasoft es que cada día me dan la oportunidad de crecer
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-profile">
                                        <a href="https://www.linkedin.com/in/dangela-garcia/">
                                            <img src="{{ URL::to('/') }}/images/resource/author-4.jpeg" alt="EQUIPO_TECNOLOGIA">
                                        </a>
                                    </div>
                                    <div class="testimonial-content">
                                        <h3 class="testimonial-title">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-profile">
                                        <a href="https://www.linkedin.com/in/anderson-guerrero/">
                                            <img src="{{ URL::to('/') }}/images/resource/author-1.jpeg" alt="EQUIPO_TECNOLOGIA">
                                        </a>
                                    </div>
                                    <div class="testimonial-content">
                                        <h3 class="testimonial-title">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-profile">
                                        <a href="https://www.linkedin.com/in/dubraska-figuera/">
                                            <img src="{{ URL::to('/') }}/images/resource/author-2.png" alt="EQUIPO_TECNOLOGIA">
                                        </a>
                                    </div>
                                    <div class="testimonial-content">
                                        <h3 class="testimonial-title">
                                        ...
                                        trabajan esmeradamente para la satisfacción de sus clientes.
                                        </p>
                                    </div>
                                </div>
