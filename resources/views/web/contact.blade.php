...
@section('description', ' Contáctenos, En Omegasoft estamos dispuestos a servirle siempre.')
@section('content')
    <section class="page-title">
        <div class="" style="opacity: 10.0;">
        <img src="{{ URL::to('/') }}/images/background/img-contactenos.jpg" alt="CONTACTENOS_CONTACTANOS">
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12" style="padding-right: 20px">
                   <div class="sec-title centered">
                       <h1 style="margin-top: 50px">Envíanos un mensaje</h1>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="sec-title centered">
                        ...
                        <div style="margin-top: 109px;">
                            <h2 style="text-align: -webkit-left;color: #00325d;margin-left: 37px; font-size: 20px; ">Dirección:</h2>
                        ...
                        <div style="margin-top: 5px;">
                            <h2 style="text-align: -webkit-left; margin-top: 10px;color: #00325d; margin-left: 37px;  font-size: 20px; ">Teléfono:</h2>
