...
@section('title', 'Omegasoft - Webcast')
@section('description', 'Omegasoft llega hasta donde usted este, con Webcast trasmitiendo online conferencias, taller o seminario ofreciendo la posibilidad de estar al día con las funcionabilidades de nuestras soluciones ITSM o temas a fines.')
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 40px;">
                    <div class="sec-title centered" style="margin-bottom: 30px">
                        ...
                        <h1 style="padding-top: 35px; font-size: 33px;">Próximamente...</h1>

                        <h2 style="padding-top: 35px; font-size: 33px;">En Omegasoft, seguimos innovando ¡Quédate en contacto! </h2>
                        <div class="text" style="text-align: center;">
                            Muy pronto tendremos disponibles webcast,
                            donde podrás interactuar con expertos en vivo, porque su éxito empresarial es nuestro mayor compromiso.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 30px">
                    ...
                    <div class="sec-title centered" style="margin-bottom:30px;border:1px solid #c2d1df;">    
                        <img style="width: 100%;" src="{{ URL::to('/') }}/images/resource/webcast-omega-itsm.jpg">
                            <div style="min-height:470px;">
                                <div class="text webcast-media1" style="text-align: center; padding: 15px;">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <img style="width: 100%;" src="{{ URL::to('/') }}/images/resource/webcast-2.jpg">
                        <div style="min-height:470px;">
                            <div class="text webcast-media2" style="text-align:center;padding:15px;">
                            ...
                            <div class="text-center button-conten-webcas" style="padding-top: 25px;">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="sec-title centered" style="margin-bottom: 30px;    border: 1px solid #c2d1df;">
                        <img style="width: 100%;" src="{{ URL::to('/') }}/images/resource/webcast-3.jpg" alt="">
                            <div style="min-height: 470px">
                                <div class="text webcast-media3" style="text-align: center; padding: 15px;">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="sec-title centered" style="margin-bottom: 30px;    border: 1px solid #c2d1df;">
                        ...
                        <div style="min-height: 470px">
                            <div class="text webcast-media4" style="text-align:center;padding:15px;">
