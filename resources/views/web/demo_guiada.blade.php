...
@section('title', 'Omegasoft - Demostración Guiada')
@section('description', 'En Omegasoft, podrá solicitar una demostración guiada por nuestros expertos, que le mostraran los beneficios de nuestras soluciones.')
@section('content')
    ...
    <section class="page-title">
            <div class="" 
                style="opacity:10.0;">
                    <img src="{{ URL::to('/') }}/images/background/DEMO_GUIADA.jpg" alt="SOLICITAR_DEMO_ONLINE">
            </div>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-5 col-xs-12" style="margin-top: 50px">
                            <div class="sec-title centered">
                                ...
                                de forma didáctica e interactiva para conocer las principales funcionalidades de
                                nuestro software para la
                                gestión de servicios IT, Omega ITSM, enmarcado en las buenas prácticas de ITIL. 
                                </p>
                                <p class="text" style="text-align: initial;margin-top: 20px;font-size: 16px;">
