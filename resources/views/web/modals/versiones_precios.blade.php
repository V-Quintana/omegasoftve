...
<!-- Modal -->
<div class="modal fade" id="myVerciones" tabindex="-1" role="dialog" aria-labelledby="myVercionesLabel">
                            ...
                            <div class="col-md-12 col-md-12 col-xs-12" style="padding-left: 0px; padding-right: 0px;">
                                <div class="form-group" style="padding-left: 0px; padding-right: 0px;">
                                    ...
                                    <div class="col-md-6 col-md-6 col-xs-6">
                                        ...
                                        <div  style="margin-bottom: 10px">
                                                <input type="text" name="company" value="" placeholder="Compañía" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        ...
                                        <div
                                            ...
                                            id="g-recaptcha-quotation"
                                            data-sitekey="6LcjmmgUAAAAAIpIHH-NyYnEJwI8xhRB2knImJDW"
                                            data-callback="callbackQuotation"
                                            data-size="invisible">
                                        </div>
                                        <div>
