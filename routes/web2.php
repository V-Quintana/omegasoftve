...
Route::get('/create-comentario/', 'BlogController@comments')->name('create-comentario');
...
Route::redirect('/public/?Variable=public', '/');
...
Route::redirect('/public/blog/helpdesk-vs-service-desk', '/blog/helpdesk-vs-service-desk');
